#!/usr/bin/env python3
"""Merge LoRA adapter into base model, push shard-by-shard to HuggingFace Hub.

Uploads each safetensor shard individually to avoid needing disk space for
the full merged model. Only requires ~5GB temp space at any time.
"""
import gc
import json
import os
...
# ── Startup checks ─────────────────────────────────────────────────────
log("=" * 60)
log("MERGE + SHARD-BY-SHARD PUSH PIPELINE")
log("=" * 60)
