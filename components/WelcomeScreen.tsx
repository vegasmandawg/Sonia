  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen bg-gray-900 text-white p-4">
      <div className="relative w-full max-w-md h-64 md:h-80 rounded-2xl overflow-hidden mb-8 shadow-2xl shadow-fuchsia-500/10">
        <img 
          src="https://picsum.photos/seed/sonia-welcome/600/800" 
          alt="Sonia AI Companion - A glimpse of your personalized companion" 
      ...
      <div className="text-center" role="main">
        ...
        <button
          ...
          aria-label="Create your personalized Sonia companion"
          data-testid="create-sonia-button"
        >
          Create Your Sonia
        </button>
        <p 
          className="text-gray-500 text-sm mt-4 cursor-pointer hover:text-gray-400" 
          role="button"
          tabIndex={0}
          onKeyPress={(e) => e.key === 'Enter' && console.log('Learn more clicked')}
          aria-label="Learn more about Sonia"
        >
          Learn More
        </p>
      </div>
