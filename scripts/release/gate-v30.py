"""
SONIA v3.0.0 Promotion Gate
============================
Runs all mandatory gates and produces a JSON report.

Usage:
    python gate-v30.py [--output-dir S:\\reports\\gate-v30]
...
OUTPUT_DIR_DEFAULT = REPO_ROOT / "reports" / "gate-v30"

EXPECTED_VERSION = "3.0.0"
EXPECTED_BRANCH = "v3.0-m4"
...
def main():
    parser = argparse.ArgumentParser(description="SONIA v3.0.0 Promotion Gate")
    ...
    print(f"=== SONIA v3.0.0 Promotion Gate ===")
