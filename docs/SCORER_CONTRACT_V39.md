# Scorer Contract -- v3.9

**Locked at:** v3.9 M0 bootstrap
**Date:** 2026-02-16
**Inherited from:** v3.8 Scorer Contract (identical rubric)
**Applies to:** All dual-pass reassessments during v3.9 development cycle
...
1. **Artifact-cited evidence only** -- every deduction must reference a specific
   file, gate result, test output, or configuration present (or absent) in the
   codebase at the assessed commit
...
1. **Enterprise-grade expectations beyond scope** -- deductions for features
   explicitly listed in the non-goals section of V3_9_SCOPE_LOCK.md are invalid
...
1. Explicitly listed as a non-goal in V3_9_SCOPE_LOCK.md, OR
2. Not cited with a specific artifact reference, OR
3. Already counted in another section (double-counting)

Then the deduction is **invalid** and must be reversed.

---

## Contract Immutability

This contract is locked at v3.9 M0 bootstrap. It CANNOT be modified during
the v3.9 development cycle. Changes require v3.10+ with re-baselining.

---

*Locked by: v3.9 M0 bootstrap commit on v3.9-dev*
